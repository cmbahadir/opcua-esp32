...
static UA_StatusCode function_simple_0_begin(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_simple_0_finish(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_simple_1_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
...
static UA_StatusCode function_simple_1_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 1001)
);
}
...
static UA_StatusCode function_simple_2_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_ObjectTypeAttributes attr = UA_ObjectTypeAttributes_default;
...
static UA_StatusCode function_simple_2_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 1002)
);
}
...
static UA_StatusCode function_simple_3_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
...
static UA_StatusCode function_simple_3_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6002)
);
}
...
static UA_StatusCode function_simple_4_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 3;
...
static UA_StatusCode function_simple_4_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6004)
);
}
...
static UA_StatusCode function_simple_5_begin(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_simple_5_finish(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
...
static UA_StatusCode function_simple_6_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
...
static UA_StatusCode function_simple_6_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6006)
);
}
...
static UA_StatusCode function_simple_7_begin(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_MethodAttributes attr = UA_MethodAttributes_default;
attr.executable = true;
...
static UA_StatusCode function_simple_7_finish(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
return UA_Server_addMethodNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 7001)
, NULL, 0, NULL, 0, NULL);
...
static UA_StatusCode function_simple_8_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 3;
...
static UA_StatusCode function_simple_8_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6001)
);
}
...
static UA_StatusCode function_simple_9_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 3;
...
static UA_StatusCode function_simple_9_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6003)
);
}
...
static UA_StatusCode function_simple_10_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_simple_10_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 6005)
);
}

UA_StatusCode simple(UA_Server *server) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
/* Use namespace ids generated by the server */
UA_UInt16 ns[2];
ns[0] = UA_Server_addNamespace(server, "http://opcfoundation.org/UA/");
ns[1] = UA_Server_addNamespace(server, "http://yourorganisation.org/example_nodeset/");
retVal |= function_simple_0_begin(server, ns);
retVal |= function_simple_1_begin(server, ns);
retVal |= function_simple_2_begin(server, ns);
retVal |= function_simple_3_begin(server, ns);
retVal |= function_simple_4_begin(server, ns);
retVal |= function_simple_5_begin(server, ns);
retVal |= function_simple_6_begin(server, ns);
retVal |= function_simple_7_begin(server, ns);
retVal |= function_simple_8_begin(server, ns);
retVal |= function_simple_9_begin(server, ns);
retVal |= function_simple_10_begin(server, ns);
retVal |= function_simple_10_finish(server, ns);
retVal |= function_simple_9_finish(server, ns);
retVal |= function_simple_8_finish(server, ns);
retVal |= function_simple_7_finish(server, ns);
retVal |= function_simple_6_finish(server, ns);
retVal |= function_simple_5_finish(server, ns);
retVal |= function_simple_4_finish(server, ns);
retVal |= function_simple_3_finish(server, ns);
retVal |= function_simple_2_finish(server, ns);
retVal |= function_simple_1_finish(server, ns);
retVal |= function_simple_0_finish(server, ns);
return retVal;
}
